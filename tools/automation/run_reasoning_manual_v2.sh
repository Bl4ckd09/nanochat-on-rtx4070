...
MANUAL_REASONING_JSONL="${MANUAL_REASONING_JSONL:-${REPO_DIR}/data/manual_reasoning_chat_v2.jsonl}"
MIN_MANUAL_ROWS="${MIN_MANUAL_ROWS:-200}"
...
DATASET_PRESET="reasoning_manual_v2" \
