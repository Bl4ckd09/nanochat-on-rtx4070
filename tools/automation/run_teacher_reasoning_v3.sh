...
MANUAL_REASONING_JSONL="${MANUAL_REASONING_JSONL:-${REPO_DIR}/data/teacher_reasoning_v3.jsonl}"
MIN_MANUAL_ROWS="${MIN_MANUAL_ROWS:-400}"
...
DATASET_PRESET="teacher_reasoning_v3" \
