...
MANUAL_REASONING_JSONL="${MANUAL_REASONING_JSONL:-${REPO_DIR}/data/teacher_reasoning_v2.jsonl}"
MIN_MANUAL_ROWS="${MIN_MANUAL_ROWS:-450}"
...
DATASET_PRESET="teacher_reasoning_v2" \
