...
| 2026-04-04 14:03 / 16:27 | `teacher_reasoning_v3` | `d24_asp48_track @ 820230` | Stricter teacher-synthetic branch with shorter normalized answers, lower math share, and fixed `s768`, deterministic, `300` steps | seed42 `50`, seed43 `300` | seed42 `1.1833`, seed43 `2.8637` | pass@8 skipped; pass@1 `0.00%` / skipped | 27.20% / skipped | skipped | completed, quick-gate fail | Seed 42 nearly cleared MMLU but produced zero GSM8K pass@1, while seed 43 collapsed on the internal loss gate; stricter filtering improved broad shape only marginally |
| 2026-04-04 17:09 / 17:17 | `teacher_distilled_v1` | `d24_asp48_track @ 820230` | Teacher-distilled short-answer branch dominated by `OpenThoughts` with small `OpenR1` and almost no `Magpie`, fixed `s768`, deterministic, `300` steps | 300 | seed42 `2.6745`, seed43 `1.9363` | skipped | skipped | skipped | completed, internal-gate fail | Both seeds were blocked by the internal loss gate before any external eval; the source mix was too narrow and over-dominated by one teacher style |
| 2026-04-04 17:49 / 18:04 | `teacher_distilled_v2` | `d24_asp48_track @ 820230` | Rebalanced distilled branch with more `Magpie`, fewer `OpenThoughts`, manual anchors, fixed `s768`, deterministic, `300` steps | 300 | seed42 `1.9144`, seed43 `1.9454` | skipped | skipped | skipped | completed, internal-gate fail | After bypassing a stuck rebuild wrapper and launching directly from the built dataset, both seeds trained stably but stayed far above the eval-loss gate, so the branch is negative evidence rather than a near miss |
...
- `teacher_reasoning_v3` improved broad-answer formatting slightly but still failed the quick gate or internal loss gate on both seeds: `/home/sun0115/nanochat-learn/notes/teacher_reasoning_v3_2026-04-04_1403_decision.md`
- `teacher_distilled_v1` failed both seeds at the internal loss gate before any external eval: `/home/sun0115/nanochat-learn/notes/teacher_distilled_v1_2026-04-04_1709_decision.md`
- `teacher_distilled_v2` reran cleanly after bypassing a stuck rebuild wrapper, but both seeds still failed the internal loss gate and never reached external eval: `/home/sun0115/nanochat-learn/notes/teacher_distilled_v2_2026-04-04_1749_decision.md`
...
- The later teacher branches add stronger negative evidence. `teacher_reasoning_v3` and both `teacher_distilled_v1/v2` variants show that stricter filtering and shorter-answer normalization alone are not enough; this stack is now saturated for local teacher-data remixes on the current 4070 setup.
...
10. Stop further local `teacher_reasoning` / `teacher_distilled` sweeps on this exact stack. Close the project around the current champions unless you introduce a materially different lever such as stronger teacher-generated data, a stronger base, or stronger hardware.
